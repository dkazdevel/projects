...
!(function (e, t) {
        ...
        (e.prototype.extendSelector = function (e, t, i, n) {
          ...
          for (r = 0; r < e.length; r++)
            (s = t[(a = e[r]).pathIndex]),
              ...
              u === a.pathIndex && r > 0
                ? (c[c.length - 1].elements =
                    c[c.length - 1].elements.concat(l))
        ...
        parsers: (r = {
          ...
          atrule: function () {
            var e,
              ...
              d = !0;
            if ("@" === s.currentChar()) {
              if ((i = this.import() || this.plugin() || this.media()))
                return i;
  ...
  !(function (e, i) {
    ...
    window.LESS_PLUGINS &&
      (Mt.plugins = Mt.plugins.concat(window.LESS_PLUGINS));
  var Et,
    Rt,
    Vt,
    Ft = (function (e, n) {
